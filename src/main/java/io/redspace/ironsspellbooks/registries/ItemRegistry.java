...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> GOLD_SPELL_BOOK = ITEMS.register("gold_spell_book", () -> new SpellBook(8, SpellRarity.RARE));
    public static final RegistryObject<Item> IRON_SPELL_BOOK = ITEMS.register("iron_spell_book", () -> new SpellBook(7, SpellRarity.UNCOMMON));
    public static final RegistryObject<Item> COPPER_SPELL_BOOK = ITEMS.register("copper_spell_book", () -> new SpellBook(6, SpellRarity.COMMON));
    public static final RegistryObject<Item> ROTTEN_SPELL_BOOK = ITEMS.register("rotten_spell_book", () -> new SpellBook(5, SpellRarity.RARE));
    public static final RegistryObject<Item> BLAZE_SPELL_BOOK = ITEMS.register("blaze_spell_book", () -> new SimpleAttributeSpellBook(10, SpellRarity.EPIC, AttributeRegistry.FIRE_SPELL_POWER.get(), .10));
    ...
    public static final RegistryObject<Item> DRUIDIC_SPELL_BOOK = ITEMS.register("druidic_spell_book", () -> new SimpleAttributeSpellBook(10, SpellRarity.EPIC, AttributeRegistry.NATURE_SPELL_POWER.get(), .10));
    ...
    public static final RegistryObject<Item> TEST_RAPIER = ITEMS.register("amethyst_rapier", () -> new AmethystRapierItem(new SpellDataRegistryHolder(SpellRegistry.STARFALL_SPELL, 8)));
